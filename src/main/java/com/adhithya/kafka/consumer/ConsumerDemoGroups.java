...
public class ConsumerDemoGroups {
	...
	public static void main(String[] args) {
		...
		String groupId = "my-fourth-application"; // by changing a group id we reset the application
		String topic = "first_topic";
		
		//if we create multiple consumers, the partition can rebalance itself
		// for ex: consumer 1 will hold 2 partitions while consumer 2 will hold only one
		// consumer will read only from corresponding partitionConsumerDemo.java
