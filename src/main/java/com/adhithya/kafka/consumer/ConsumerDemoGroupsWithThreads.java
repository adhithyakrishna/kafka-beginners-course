...
public class ConsumerDemoGroupsWithThreads {

	public static void main(String[] args) {
		new ConsumerDemoGroupsWithThreads().run();
	}

	private ConsumerDemoGroupsWithThreads() {

    }

	private void run() {
		Logger logger = LoggerFactory.getLogger(ConsumerDemoGroupsWithThreads.class.getName());
